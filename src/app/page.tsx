...
export default function Home() {
  ...
  return (
    <>
      <div className="min-h-screen w-full bg-gradient-to-br from-gray-900 via-blue-900 to-black font-body text-white flex flex-col items-center">
        <header className="w-full px-4 md:px-8 py-4 sticky top-0 z-50 bg-gray-900/50 backdrop-blur-sm">
