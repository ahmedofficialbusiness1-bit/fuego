...
export default function Home() {
  ...
  return (
    <>
      <div className="min-h-screen w-full font-body text-white flex flex-col md:flex-row">
        {/* Left Column */}
        <div className="w-full md:w-1/2 bg-gradient-to-br from-gray-900 via-blue-900 to-black flex flex-col items-center p-4 md:p-8">
        ...
        {/* Right Column */}
        <div className="w-full md:w-1/2 bg-gray-100 dark:bg-gray-800 flex items-center justify-center p-4 md:p-8">
